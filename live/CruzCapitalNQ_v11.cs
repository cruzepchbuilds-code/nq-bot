// CruzCapitalNQ_v11.cs — NinjaTrader 8 Strategy
// CruzCapital NQ — Lucid Trading 50K  |  4 sub-strategies, 1 risk engine
//
// HOW TO INSTALL:
//   1. Copy to Documents\NinjaTrader 8\bin\Custom\Strategies\CruzCapitalNQ_v11.cs
//   2. NT8: NinjaScript Editor → Compile All (F5)
//   3. Add "CruzCapitalNQ v11" to NQ Continuous (#F) 1-min chart
...
{
    public class CruzCapitalNQ_v11 : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "CruzCapital NQ v11 — ORB + rejection + PM + Asia, risk engine v2";
